                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="username"><g:message code="comment.username.label" default="Username" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: commentInstance, field: 'username', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="notes"><g:message code="comment.notes.label" default="Notes" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: commentInstance, field: 'notes', 'errors')}">
                                    <g:select name="notes.id" from="${org.sb.mynotes.domain.Note.list()}" optionKey="id" value="${commentInstance?.notes?.id}"  />
                                </td>
                            </tr>
